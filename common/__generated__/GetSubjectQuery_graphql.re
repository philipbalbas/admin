...
module Types = {
  type response_getSubject_topics = {
    id: string,
    name: string,
  ...
  type response_getSubject = {
    name: string,
    description: option(string),
    topics: option(array(response_getSubject_topics)),
  };
...
module Internal = {
  ...
  let responseConverter: Js.Dict.t(Js.Dict.t(Js.Dict.t(string))) = [%raw
    {json| {"__root":{"getSubject":{"n":""},"getSubject_description":{"n":""},"getSubject_topics":{"n":""},"getSubject_topics_description":{"n":""},"getSubject_topics_order":{"n":""}}} |json}
  ];
