...
module Types = {
  type response_getModule_subjects = {
    id: string,
    name: string,
  ...
  type response_getModule = {
    ...
    name: string,
    description: string,
    subjects: option(array(response_getModule_subjects)),
  };
...
module Internal = {
  ...
  let responseConverter: Js.Dict.t(Js.Dict.t(Js.Dict.t(string))) = [%raw
    {json| {"__root":{"getModule":{"n":""},"getModule_subjects":{"n":""},"getModule_subjects_description":{"n":""},"getModule_subjects_order":{"n":""}}} |json}
  ];
