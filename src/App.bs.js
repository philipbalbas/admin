    ...
    switch (match[0]) {
      case "modules" : 
          ...
          if (match$1) {
            ...
            var id = match$1[0];
            if (match$2) {
              if (match$2[0] === "subjects") {
                var match$3 = match$2[1];
                if (match$3) {
                  var id$1 = match$3[0];
                  var exit = 0;
                  if (id$1 === "create" && !match$3[1]) {
                  ...
                  if (exit === 1) {
                    ...
                    if (match$4) {
                      if (match$4[0] === "topics") {
                        ...
                        container = match$5 && match$5[0] === "create" && !match$5[1] ? React.createElement(TopicsForm$ReactHooksTemplate.make, {
                                moduleIdProp: id,
                                subjectIdProp: id$1
                              }) : "Page Not Found";
                      } else {
      ...
      case "notes" : 
          ...
          if (match$6) {
            ...
            container = id$2 === "create" ? (
                match$6[1] ? "Page Not Found" : React.createElement(NotesForm$ReactHooksTemplate.make, { })
              ) : (
                match$6[1] ? "Page Not Found" : React.createElement(Note$ReactHooksTemplate.make, {
                        id: id$2
                      })
              );
          } else {
      ...
      case "pages" : 
          ...
          if (match$7) {
            ...
            container = id$3 === "create" ? (
                match$7[1] ? "Page Not Found" : React.createElement(PagesForm$ReactHooksTemplate.make, { })
              ) : (
                match$7[1] ? "Page Not Found" : React.createElement(Page$ReactHooksTemplate.make, {
                        id: id$3
                      })
              );
          } else {
              ...
              if (match$9) {
                if (match$9[0] === "topics") {
                  ...
                  if (match$10) {
                    ...
                    if (match$11 && match$11[0] === "pages") {
                      var match$12 = match$11[1];
                      container = match$12 && match$12[0] === "create" && !match$12[1] ? React.createElement(PagesForm$ReactHooksTemplate.make, {
                              subjectIdProp: id$4,
                              topicIdProp: match$10[0]
                            }) : "Page Not Found";
                    } else {
                      container = "Page Not Found";
                    }
              ...
              if (match$14) {
                if (match$14[0] === "pages") {
                  ...
                  if (match$15) {
                    ...
                    if (match$16 && match$16[0] === "notes") {
                      var match$17 = match$16[1];
                      container = match$17 && match$17[0] === "create" && !match$17[1] ? React.createElement(NotesForm$ReactHooksTemplate.make, {
                              topicIdProp: id$5,
                              pageIdProp: match$15[0]
                            }) : "Page Not Found";
                    } else {
                      container = "Page Not Found";
                    }
