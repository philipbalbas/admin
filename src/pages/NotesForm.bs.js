...
function NotesForm(Props) {
  ...
  if (typeof topicsListQueryResponse === "number") {
    topicsSelect = topicsListQueryResponse === /* Fetching */0 ? Utils$ReactHooksTemplate.str("Loading") : Utils$ReactHooksTemplate.str("Not Found");
  ...
  if (typeof topicQueryResponse === "number") {
    pageSelect = topicQueryResponse === /* Fetching */0 ? Utils$ReactHooksTemplate.str("Loading") : Utils$ReactHooksTemplate.str("Not Found");
