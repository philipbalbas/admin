...
function PagesForm(Props) {
  ...
  var subjectsListRequest = Queries$ReactHooksTemplate.ListSubjects[/* make */3](/* () */0);
  var match$4 = Curry._4(ReasonUrql.Hooks[/* useQuery */1], subjectsListRequest, undefined, undefined, /* () */0);
  var subjectsListQueryResponse = match$4[0][/* response */3];
  var subjectQuery = Queries$ReactHooksTemplate.GetSubject[/* make */3](subjectId, /* () */0);
  var match$5 = Curry._4(ReasonUrql.Hooks[/* useQuery */1], subjectQuery, undefined, undefined, /* () */0);
  var subjectQueryResponse = match$5[0][/* response */3];
  var mutation = Mutations$ReactHooksTemplate.CreatePage[/* make */3](name, topicId, description, undefined, /* () */0);
  ...
  if (typeof subjectsListQueryResponse === "number") {
    subjectsSelect = subjectsListQueryResponse === 0 ? Utils$ReactHooksTemplate.str("Loading") : Utils$ReactHooksTemplate.str("Not Found");
  ...
  if (typeof subjectQueryResponse === "number") {
    topicsSelect = subjectQueryResponse === 0 ? Utils$ReactHooksTemplate.str("Loading") : Utils$ReactHooksTemplate.str("Not Found");
